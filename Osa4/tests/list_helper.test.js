...
describe('total likes', () => {
  ...
  test('when list has more than one blog and sum of likes are correct', () => {
...
describe('most blogs', () => {
  ...
  test('when list has many blogs', () => {
    ...
    expect(result).toEqual(sixBlogs)
  })
...
describe('most likes', () => {
  ...
  test('when list has only one blog', () => {
    ...
    expect(result).toEqual(oneBlogLikes)
  })

  test('when list has many blogs', () => {
    const result = listHelper.mostLikes(listWithSixBlogs)
    expect(result).toEqual(sixBlogsLikes)
  })
